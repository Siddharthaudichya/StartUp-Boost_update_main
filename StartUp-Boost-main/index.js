...
function DyanamicString(){
    let initialPath = `M 100 10 Q 100 600 100 1200`
    let finalPath = `M 100 10 Q 100 600 100 1200`
    const string = document.querySelector('#curve-line')

    string.addEventListener('mousemove',(dets)=>{
        initialPath=`M 100 10 Q ${dets.x} 600 100 1200`
        gsap.to('svg path',{
            attr:{d:initialPath}
        })
    })
